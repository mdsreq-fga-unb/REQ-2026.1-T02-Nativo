...
Os requisitos funcionais estabelecem um consenso no qual fomentam a implementação dos objetivos planejados para o app Nativo. A seguir são apresentados um conjunto preliminar dos requisitos funcionais. O ajuste do tamanho da fonte foi tratado como requisito não funcional, por estar relacionado a acessibilidade.
...
| RF05 | Editar associação de vídeo | Permitir que administradores e moderadores alterem qual vídeo está associado a cada tradução. |
| RF06 | Desassociar vídeo da tradução | O sistema deve permitir que administradores e moderadores removam a associação entre um vídeo e uma tradução específica. |
...
| RF09 | Associar áudio à tradução | Permitir que administradores e moderadores vinculem áudios cadastrados a uma tradução específica. |
| RF10 | Reproduzir áudio | O sistema deve permitir que os usuários reproduzam os áudios vinculados às traduções. |
| RF11 | Editar associação de áudio | Permitir que administradores e moderadores alterem qual áudio está associado à tradução. |
| RF12 | Desassociar áudio da tradução | O sistema deve permitir que administradores e moderadores removam a associação entre um áudio e uma tradução específica. |
| RF13 | Excluir áudio | O sistema deve permitir que os moderadores apaguem (excluam definitivamente) um áudio da base de dados. |
| RF14 | Criar atividade educacional | Permitir que professores criem atividades para os usuários resolverem. |
| RF15 | Listar atividades | Permitir que os usuários visualizem a lista de atividades disponíveis para resolução. |
| RF16 | Responder atividade | Permitir que os usuários submetam respostas às atividades publicadas. |
...
| RF18 | Editar atividade | Permitir que professores, administradores e moderadores editem o conteúdo de uma atividade. |
| RF19 | Excluir atividade | Permitir que professores, administradores e moderadores excluam uma atividade. |
