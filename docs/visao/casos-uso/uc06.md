...
> Espaço reservado para inserir as regras de negócio definitivas da UC06.

## 8. Requisitos Relacionados

| RF | Relação com a UC |
| :--- | :--- |
| <span id="uc06-rf20" class="rf-anchor"></span>[**RF20 - Banir usuário**](../requisitos.md#req-rf20) | Permite que moderadores e administradores banam usuários infratores da aplicação. |
