...
### **Iteração 9 (04/06 a 10/06)**  
  * **Objetivos:** Concluir as ferramentas de edição de atividades. 
  * **Atividades:** Desenvolvimento das interfaces de edição de atividades do professor. 
  * **Entregáveis:** Sistema de atividades integrado e validado e **Primeira Release entregue!**  
### **Iteração 10 (11/06 a 19/06)**  
  * **Objetivos:** Desenvolver o Sistema de gamificação e sistema de administração de acesso.  
