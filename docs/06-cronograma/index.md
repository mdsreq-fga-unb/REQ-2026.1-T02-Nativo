...
<div class="section-cards">
  <a class="section-card" href="concepcao/">
    ...
    <p>02/04 – 22/04 · Iterações 1 e 2 · Definição do problema, viabilidade e escopo.</p>
  </a>
  <a class="section-card" href="elaboracao/">
    <h3>Fase de Elaboração</h3>
    <p>23/04 – 22/05 · Iterações 3 a 5 · Detalhamento funcional, modelagem de interface, refatoração técnica e definição do compromisso do MVP.</p>
  </a>
  <a class="section-card" href="construcao/">
    <h3>Fase de Construção</h3>
    <p>11/05 – 24/06 · Iterações 6 a 11 · Desenvolvimento incremental com validação contínua.</p>
  </a>
  <a class="section-card" href="transicao/">
    <h3>Fase de Transição</h3>
    <p>25/06 – 03/07 · Iterações 12 e 13 · Homologação em campo e entrega final.</p>
  </a>
</div>