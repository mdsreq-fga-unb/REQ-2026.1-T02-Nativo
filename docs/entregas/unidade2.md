...
<div style="margin: 20px 0; overflow: hidden; background-color: #111;">
  <iframe src="../../img/unidade2/Histórias de Usuário.pdf" title="Visualização dos slides da Unidade 1" style="display: block; width: 100%; height: 80vh; border: 0; background-color: #111;"></iframe>
</div>
...
**Resumo da Reunião:**
Nesta sessão de encerramento da Fase de Elaboração, a equipe realizou a priorização do backlog por meio de uma **Matriz de Impacto no Negócio vs. Dificuldade Técnica**, estabelecendo o escopo do *Minimum Viable Product* (MVP). 
