...
<div class="shortcut-cards">
  <a class="shortcut-card shortcut-card--mvp" href="visao/mvp/">
    <span class="shortcut-card__tag">10</span>
    <h3>MVP</h3>
    <p>Escopo priorizado, UCs entregues e matriz de priorização.</p>
  </a>

  <a class="shortcut-card shortcut-card--timeline" href="visao/cronograma/">
    <span class="shortcut-card__tag">11</span>
    <h3>Cronograma</h3>
    <p>Iterações, fases do OpenUP e evidências de cada entrega.</p>
  </a>

  <a class="shortcut-card shortcut-card--trace" href="visao/rastreabilidade/">
    <span class="shortcut-card__tag">12</span>
    <h3>Rastreabilidade</h3>
    <p>Mapeamento entre problema, OEs, CPs, RFs e UCs.</p>
  </a>
</div>
...
<a class="repo-button" href="https://github.com/Requisitos-Anawe/Nativo" target="_blank" rel="noopener">
  Clique aqui para acessar o Repositório de Desenvolvimento
</a>
...
| 05/04/26 | 0.6 | Preenchimento tópico 1.7 | Giovanna |
| 05/04/26 | 0.7 | Adição do Diagrama de Ishikawa e Rich Picture | Pedro Silva e Giovanna |
...
| 10/04/26 | 1.8 | Preenchimento dos tópicos 4.1 4.2 e revisão do documento | Giovanna |
...
| 16/05/26 | 2.3 | Escrita inicial dos Casos de Uso | Giovanna |
