...
**Entregáveis:**
- Documento de Visão (tópicos 1 a 6)
- Diagrama de Ishikawa e Rich Picture
...
**Entregáveis:**
- Lista consolidada de Requisitos Funcionais (RFs) e Não Funcionais (RNFs)
- Especificação de Casos de Uso
- Protótipos navegáveis de interface
